...
router.post(
	'/createAdd/:id_equipement',
	historiqueController.createAddEqHistory,
);
router.post(
	'/createDelete/:id_equipement',
	historiqueController.createDeleteHistory,
);
...
router.post(
	'/update/:id_equipement',
	historiqueController.updateEquipmentHistory,
);
